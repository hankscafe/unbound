...
- **Store search, wishlist & credit purchases** — search Audible's catalog per account, manage
  wishlists, and (opt-in, per-user permission) buy titles with **credits only** — the payment
  card is never touched. Purchases sync and download automatically.
